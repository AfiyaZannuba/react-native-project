...
const SignUp = () => {
    ...
    if (
        ...
        console.log('Verification screen - local emailAddress:', emailAddress, 'signUp.emailAddress:', signUp.emailAddress, 'signUp status:', signUp.status);
        return (
                        ...
                        <View className="auth-content">
                            ...
                            <View className="auth-brand-block">
                                ...
                                <Text className="auth-subtitle">
                                    We sent a verification code to {signUp.emailAddress || emailAddress || 'your email'}
                                </Text>
                            </View>
